...
@app.post("/staging-sean/sdschat/v1/completions", dependencies=[Depends(check_api_key)])
...
@app.post("/staging-sean/sdschat/v1/embeddings", dependencies=[Depends(check_api_key)])
@app.post("/staging-sean/sdschat/v1/engines/{model_name}/embeddings", dependencies=[Depends(check_api_key)])
...
@app.post("/staging-sean/sdschat/api/v1/token_check")
...
@app.post("/staging-sean/sdschat/api/v1/chat/completions")
